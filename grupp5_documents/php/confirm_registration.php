	...
	if($count > 0){  // Record exists. Update status to confirmed.
		if (mysqli_query($con,"UPDATE iths_users SET status=1, confirm_code=null WHERE confirm_code='$code'")) { // User's status confirmed.  
			echo "<html>
              ...
              <body>
                <div style='background-color:black; top:0; bottom:0; left:0; right:0; margin:auto; position:absolute; width:60%; height:30%; padding-top:50px; border:solid 1px; border-color:LightGray; box-shadow: 9px 9px 9px LightSlateGray; text-align:center'> 
                  <h1 style='color:white; font-weight:bold'>Welcome to the ITHS-Blogg!</h1>
			...
			echo "<html>
              ...
              <body>
                <div style='background-color:black; top:0; bottom:0; left:0; right:0; margin:auto; position:absolute; width:60%; height:30%; padding-top:50px; border:solid 1px; border-color:LightGray; box-shadow: 9px 9px 9px LightSlateGray; text-align:center'> 
                  <h1 style='color:white; font-weight:bold'>Our aplologies!<small> - ITHS-Blogg</small></h1>
		...
		echo "<html>
            ...
            <body>
              <div style='background-color:black; top:0; bottom:0; left:0; right:0; margin:auto; position:absolute; width:60%; height:30%; padding-top:50px; border:solid 1px; border-color:LightGray; box-shadow: 9px 9px 9px LightSlateGray; text-align:center'> 
                <h1 style='color:white; font-weight:bold'>Attention Please!<small> - ITHS-Blogg</small></h1>
